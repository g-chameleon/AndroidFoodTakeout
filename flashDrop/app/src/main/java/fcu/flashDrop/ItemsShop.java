...
class ItemsShop implements Serializable {
    ...
    public ItemsShop(int shop_image,String shop_name,String shop_sale,String shop_cost,String shop_welfare,String shop_time) {
    ...
    public void setShop_sale(String shop_sale){this.shop_sale = shop_sale;}

    public String getShop_cost() { return shop_cost;}
    public void setShop_cost(String shop_cost){this.shop_cost= shop_cost;}

    public String getShop_welfare() { return shop_welfare;}
    public void setShop_welfare(String shop_welfare){this.shop_welfare = shop_welfare;}

...
public class ShopDetailActivity extends AppCompatActivity {
    ...
    private final int[] food_image = {R.drawable.kfc1,R.drawable.kfc2,R.drawable.kfc3,
                                      ...
                                      R.drawable.bking1,R.drawable.bking2,R.drawable.bking3};
    private final String[] food_name = {"炸鷄套餐", "雙層漢堡", "超級套餐", "巨無霸", "小食套餐", "可樂", "香腸披薩",
            "海鮮披薩", "海陸雙排", "拿鐵咖啡", "美式咖啡", "帕尼尼","牛肉山堡","明星套餐","紅豆牛肉堡"};
    private final String[] food_taste = {"炸雞，薯條，可樂","麵包，雞肉，生菜","漢堡，可樂，雞塊，炸雞，土豆泥","牛肉餅，麵包，生菜","雞翅，可樂，薯條","可樂","香腸，橄欖，芝士","蝦仁，魷魚，橄欖，青椒","海鮮","拿鐵","美式咖啡","帕尼尼","牛肉，蔬菜","蝦仁，薯條，可樂","紅豆，牛肉"};
    private final String[] food_sale = {"月售：66","月售：104","月售：274","月售：87","月售：923","月售：23","月售：443","月售：123","月售：352","月售：155","月售：23","月售：222","月售：230","月售：232","月售：230"};
    private final String[] food_price = {"￥130","￥70","￥230", "￥100", "￥160", "￥40", "￥170",
            "￥200", "￥230", "￥130", "￥120", "￥70","￥70", "￥170", "￥60"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(albumNo==4){
            textView = (TextView)findViewById(R.id.tv_shop_name);
            //使用setText()方法修改文本
            textView.setText(R.string.tv_shop_name4);

            textView = (TextView)findViewById(R.id.tv_time);
            //使用setText()方法修改文本
            textView.setText(R.string.tv_time4);

            textView = (TextView)findViewById(R.id.tv_notice);
            //使用setText()方法修改文本
            textView.setText(R.string.tv_notice4);
